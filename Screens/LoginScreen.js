...
class LoginScreen extends Component {
    ...
    increaseHeightOfLogin = () => {
        ...
        this.setState({ placeholderText: '7799409191' })
                ...
                >
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Animatable.View
                            ...
                            style={{ backgroundColor: 'white', height: 150, width: 150, alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 24 }}>Bharath</Text>
                        </Animatable.View>
                    </View>
